...
<form action="{{route('posts.store')}} " method="POST" enctype="multipart/form-data">
  @csrf
  @method('POST')
   <center><h1>Kreiraj post</h1></center>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <textarea type="text" class="form-control" id="exampleInputPassword1" name="short_description"></textarea>
  </div>
  <div class="mb-3 ">
    
    <label class="form-check-label" for="exampleCheck1">Content</label>
    <textarea name="content" class="form-control"  id="exampleCheck1" cols="30" rows="6"></textarea>
  </div>
  <div class="mb-3 ">
